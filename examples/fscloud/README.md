...
6. Restricting network traffic flow for pseudo `IAM` service. To restrict IAM service, `service-group-id` is required to be specified to enable restriction for `all-iam-account-management-services`.
