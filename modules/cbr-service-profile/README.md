...
| <a name="input_zone_service_ref_list"></a> [zone\_service\_ref\_list](#input\_zone\_service\_ref\_list) | Provide a valid service reference for zone creation with optional service reference location | <pre>map(object({<br>    serviceRef_location = optional(string)<br>  }))</pre> | n/a | yes |
