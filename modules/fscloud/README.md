...
| <a name="input_key_protect"></a> [key\_protect](#input\_key\_protect) | List specific Key Management Service (KMS) type, valid values are 'kms' for Key Protect and 'hs-crypto' for HPCS | `list(string)` | <pre>[<br>  "hs-crypto"<br>]</pre> | no |
