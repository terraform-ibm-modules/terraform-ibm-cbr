...
| <a name="input_appconfig_aggregator_services"></a> [appconfig\_aggregator\_services](#input\_appconfig\_aggregator\_services) | List of services AppConfig can aggregate. Full list of services can be found [here](https://cloud.ibm.com/docs/app-configuration?topic=app-configuration-ac-configuration-aggregator#ac-list-of-services-configaggregator). Service references are not supported for databases. | `list(string)` | <pre>[<br/>  "cloud-object-storage",<br/>  "is",<br/>  "secrets-manager",<br/>  "container-registry",<br/>  "codeengine",<br/>  "messagehub",<br/>  "toolchain",<br/>  "cloudantnosqldb",<br/>  "schematics",<br/>  "sysdig-monitor",<br/>  "compliance",<br/>  "hs-crypto",<br/>  "appid",<br/>  "apprapp",<br/>  "event-notifications",<br/>  "project",<br/>  "pm-20",<br/>  "logs"<br/>]</pre> | no |
...
| <a name="input_enable_appconfig_aggregator_flows"></a> [enable\_appconfig\_aggregator\_flows](#input\_enable\_appconfig\_aggregator\_flows) | Map of bools to enable/disable AppConfig flows per service. | `map(bool)` | <pre>{<br/>  "appid": false,<br/>  "apprapp": false,<br/>  "cloud-object-storage": false,<br/>  "cloudantnosqldb": false,<br/>  "codeengine": false,<br/>  "compliance": false,<br/>  "container-registry": false,<br/>  "event-notifications": false,<br/>  "hs-crypto": false,<br/>  "is": false,<br/>  "logs": false,<br/>  "messagehub": false,<br/>  "pm-20": false,<br/>  "project": false,<br/>  "schematics": false,<br/>  "secrets-manager": false,<br/>  "sysdig-monitor": false,<br/>  "toolchain": false<br/>}</pre> | no |
