...
| <a name="input_appconfig_aggregator_services"></a> [appconfig\_aggregator\_services](#input\_appconfig\_aggregator\_services) | List of services AppConfig can aggregate | `list(string)` | <pre>[<br/>  "cloud-object-storage",<br/>  "containers-kubernetes",<br/>  "is",<br/>  "secrets-manager",<br/>  "container-registry",<br/>  "codeengine",<br/>  "messagehub",<br/>  "toolchain",<br/>  "cloudantnosqldb",<br/>  "schematics",<br/>  "sysdig-monitor",<br/>  "compliance",<br/>  "hs-crypto",<br/>  "appid",<br/>  "apprapp",<br/>  "event-notifications",<br/>  "messages-for-rabbitmq",<br/>  "project",<br/>  "pm-20",<br/>  "logs"<br/>]</pre> | no |
...
| <a name="input_enable_appconfig_aggregator_flows"></a> [enable\_appconfig\_aggregator\_flows](#input\_enable\_appconfig\_aggregator\_flows) | Map of bools to enable/disable AppConfig flows per service | `map(bool)` | <pre>{<br/>  "appid": true,<br/>  "apprapp": true,<br/>  "cloud-object-storage": true,<br/>  "cloudantnosqldb": true,<br/>  "codeengine": true,<br/>  "compliance": true,<br/>  "container-registry": true,<br/>  "containers-kubernetes": true,<br/>  "event-notifications": true,<br/>  "hs-crypto": true,<br/>  "is": true,<br/>  "logs": true,<br/>  "messagehub": true,<br/>  "messages-for-rabbitmq": true,<br/>  "pm-20": true,<br/>  "project": true,<br/>  "schematics": true,<br/>  "secrets-manager": true,<br/>  "sysdig-monitor": true,<br/>  "toolchain": true<br/>}</pre> | no |
