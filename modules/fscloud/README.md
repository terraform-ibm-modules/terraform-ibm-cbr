...
| <a name="input_appconfig_aggregator_services"></a> [appconfig\_aggregator\_services](#input\_appconfig\_aggregator\_services) | List of services AppConfig can aggregate | `list(string)` | <pre>[<br/>  "cloud-object-storage",<br/>  "event-notifications",<br/>  "secrets-manager"<br/>]</pre> | no |
...
| <a name="input_enable_appconfig_aggregator_flows"></a> [enable\_appconfig\_aggregator\_flows](#input\_enable\_appconfig\_aggregator\_flows) | Map of bools to enable/disable AppConfig flows per service | `map(bool)` | <pre>{<br/>  "cloud-object-storage": true,<br/>  "event-notifications": true,<br/>  "functions": true,<br/>  "resource-alias": true,<br/>  "resource-bindings": true,<br/>  "resource-controller": true,<br/>  "resource-group": true,<br/>  "resource-instances": true,<br/>  "resource-keys": true,<br/>  "resource-lock": true,<br/>  "resource-manager": true,<br/>  "resource-quota": true,<br/>  "resource-service-binding": true,<br/>  "resource-service-instance": true,<br/>  "resource-service-key": true,<br/>  "resource-tag": true,<br/>  "resource-usage": true,<br/>  "secrets-manager": true<br/>}</pre> | no |
