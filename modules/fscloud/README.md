...
|------|-------------|------|---------|:--------:|
| <a name="input_allow_appconfig_to_appconfig_aggregator_services"></a> [allow\_appconfig\_to\_appconfig\_aggregator\_services](#input\_allow\_appconfig\_to\_appconfig\_aggregator\_services) | Set rule for App Configuration to list of services supported by configuration aggregator, default is true. Full list of services can be found [here](https://cloud.ibm.com/docs/app-configuration?topic=app-configuration-ac-configuration-aggregator#ac-list-of-services-configaggregator). Service references are not supported for databases. | `map(bool)` | <pre>{<br/>  "IAM": true,<br/>  "apprapp": true,<br/>  "atracker": true,<br/>  "cloud-object-storage": true,<br/>  "codeengine": true,<br/>  "container-registry": true,<br/>  "containers-kubernetes": true,<br/>  "dns-svcs": true,<br/>  "event-notifications": true,<br/>  "globalcatalog-collection": true,<br/>  "hs-crypto": true,<br/>  "is": true,<br/>  "kms": true,<br/>  "logs": true,<br/>  "messagehub": true,<br/>  "messages-for-rabbitmq": true,<br/>  "schematics": true,<br/>  "secrets-manager": true,<br/>  "sysdig-monitor": true,<br/>  "sysdig-secure": true,<br/>  "transit": true<br/>}</pre> | no |
...
| <a name="input_allow_scc_wp_to_appconfig"></a> [allow\_scc\_wp\_to\_appconfig](#input\_allow\_scc\_wp\_to\_appconfig) | Set rule for Security and Compliance Center Workload Protection (SCC-WP) to App Configuration, default is true | `bool` | `true` | no |
| <a name="input_allow_scc_wp_to_cos"></a> [allow\_scc\_wp\_to\_cos](#input\_allow\_scc\_wp\_to\_cos) | Set rule for Security and Compliance Center Workload Protection (SCC-WP) to COS, default is true | `bool` | `true` | no |
