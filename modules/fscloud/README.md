...
| <a name="input_enable_appconfig_aggregator_flows"></a> [enable\_appconfig\_aggregator\_flows](#input\_enable\_appconfig\_aggregator\_flows) | Map of bools to enable/disable AppConfig flows per service. | `map(bool)` | <pre>{<br/>  "appid": false,<br/>  "apprapp": false,<br/>  "cloud-object-storage": false,<br/>  "cloudantnosqldb": false,<br/>  "codeengine": false,<br/>  "compliance": false,<br/>  "container-registry": false,<br/>  "event-notifications": false,<br/>  "hs-crypto": false,<br/>  "is": false,<br/>  "logs": false,<br/>  "messagehub": false,<br/>  "schematics": false,<br/>  "secrets-manager": false,<br/>  "sysdig-monitor": false,<br/>  "toolchain": false<br/>}</pre> | no |
