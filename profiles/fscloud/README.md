...
| <a name="input_zone_allowed_ip_list"></a> [zone\_allowed\_ip\_list](#input\_zone\_allowed\_ip\_list) | (List) Allowed IP addresses for the zones | `list(string)` | `[]` | no |
| <a name="input_zone_allowed_ip_range_list"></a> [zone\_allowed\_ip\_range\_list](#input\_zone\_allowed\_ip\_range\_list) | (List) Allowed IP range for the zones | `list(string)` | `[]` | no |
| <a name="input_zone_allowed_subnet_list"></a> [zone\_allowed\_subnet\_list](#input\_zone\_allowed\_subnet\_list) | (List) Allowed subnet list for the zones | `list(string)` | `[]` | no |
| <a name="input_zone_excluded_ip_range_list"></a> [zone\_excluded\_ip\_range\_list](#input\_zone\_excluded\_ip\_range\_list) | (List) Excluded IP range for the zones | `list(string)` | `[]` | no |
| <a name="input_zone_excluded_subnet_list"></a> [zone\_excluded\_subnet\_list](#input\_zone\_excluded\_subnet\_list) | (List) Excluded subnet list for the zones | `list(string)` | `[]` | no |
| <a name="input_zone_exluded_ip_list"></a> [zone\_exluded\_ip\_list](#input\_zone\_exluded\_ip\_list) | (List) Excluded IP address for the zones | `list(string)` | `[]` | no |
